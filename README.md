...
The **RegistryGr.id** is the **central repository** for all **AGIGrid** and **AIGrid** projects.
It consolidates **registries, databases, and runtime services** into one unified system, ensuring **discoverability, governance, and execution** across the Grid ecosystem.
