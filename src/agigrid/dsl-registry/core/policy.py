...
from .schema import SpecObject, TemplateObject
...
def onboard_policy_for_spec(
    spec: "SpecObject",
    code_url: str,
    description: str,
    release_tag: str = "stable",
    endpoint: str = POLICY_SERVER_URL
) -> str:
    ...
    spec.backend_policy_rule_ids["default"] = policy_uri
    return policy_uri


def onboard_policy_for_template(
